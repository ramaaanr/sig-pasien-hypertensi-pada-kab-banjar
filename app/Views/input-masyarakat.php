...
<!-- Pastikan file ini disimpan sebagai file PHP (misalnya script.php) -->
<script>
...
document.addEventListener('DOMContentLoaded', function() {
  $.ajax({
    url: '<?= base_url('DataKecamatan/get_kecamatan'); ?>', // Menggunakan base_url() untuk URL base
    type: 'GET',
    dataType: 'json',
  ...
  $('#data-masyarakat-form').on('submit', function(event) {
    ...
    $.ajax({
      url: '<?= base_url('DataMasyarakat/insert'); ?>', // Menggunakan base_url() untuk URL base
      type: 'POST',
      data: formData,
      success: function(response) {
        ...
        Swal.fire({
          ...
          icon: 'success',
                ...
                // Redirect ke halaman utama setelah alert ditutup
                window.location.href = '<?= base_url('/DataMasyarakat') ?>' ; // Ganti dengan URL yang sesuai
            });;
