...
$(document).ready(function() {
  $.ajax({  // data untuk inputan di peta
    ...
    success: function(data) {
      ...
      }); // membuat option untuk element select
    },
    error: function(xhr, status, error) {
      console.error('Error fetching data:', error);
    }
  }); // data untuk inputan di peta
  ...
  $('#kecamatan').change(function() {
    ...
    if (kecamatanId) {
      $.ajax({ // untuk memanggil data warna dan populasi pada peta
        url: '<?= base_url(); ?>data/get_kecamatan_by_id/' + kecamatanId,
        type: 'GET',
        dataType: 'json',
        success: function(data) {
  ...
  });  // untuk memanggil data warna dan populasi pada peta 
