        ...
        <div class="py-4">
          <ul>
            ...
            <li class="py-2 px-4 text-white hover:bg-gray-800 flex items-center cursor-pointer">
              ...
              <a href='<?= base_url('/DataKecamatan') ?>'>Rekapitulasi</a>
            </li>
            ...
            <li class="py-2 px-4 text-white hover:bg-gray-800 flex items-center cursor-pointer">
              ...
              <a href='<?= base_url('/DataMasyarakat/showInputMasyarakat') ?>'>Input Penduduk</a>
            </li>
            ...
            <li class="py-2 px-4 text-white hover:bg-gray-800 flex items-center cursor-pointer">
              ...
              <a href='<?= base_url('/DataMasyarakat') ?>'>Daftar Penduduk</a>
            </li>
